...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'pi.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'pi.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'pi.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "pi.html.mem" : null;
...
var _get_pi = Module["_get_pi"] = function() { return Module["asm"]["_get_pi"].apply(null, arguments) };
